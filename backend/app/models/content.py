...
class Video(Base):
    """Admin-managed videos (uploaded file and/or YouTube URL)."""

    __tablename__ = "videos"
    __table_args__ = (UniqueConstraint("language", "slug", name="uq_videos_language_slug"),)
    ...
    category = relationship("Category")
    tags = relationship("Tag", secondary="video_tags", lazy="selectin")
